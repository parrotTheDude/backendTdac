<!-- resources/views/subscriptions/create-list.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Create New Email List</title>
...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <!-- JavaScript for live preview of code-friendly name -->
    <script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Update on initial load and whenever the user types
